...
def check_config_file(config_file):
    ...
    if config_file["trainer"] is not None:
        ...
        assert "module_name" in config_file["trainer"]["data_loader"].keys(), (
            base_message
            + "Please use the keywords [module_name] in the loss dictionary"
        )
        ...
        assert "lr" in opt_params.keys(), (
            base_message
            + "Please use the keywords [lr] in the optimizer_params dictionary"
        )
